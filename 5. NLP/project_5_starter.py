...
def get_document_type(doc):
    ...
    print(doct[0][-4:].lower())
    return doct[0][-4:].lower()
...
#     print(bool_array)
    ...
    for i in bool_array :
        jaccard_similarities.append(jaccard_similarity_score(i, bool_array[1,:]))
       
    print(bool_array[0:])
    jaccard_similarities.remove(1) 
...
def get_cosine_similarity(tfidf_matrix):
    ...
    # TODO: Implement
    results = []
    val = cosine_similarity(tfidf_matrix)
    print('val==>',val)
